...
1. **Define topic**: Ask for the precise topic, constraints, and any seed papers or target venues. If the user is exploring a new research direction, briefly probe feasibility and impact before searching. Ask: "What would success look like? What are the main risks?"
