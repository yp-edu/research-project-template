...
To resume the contribution development workflow from where it was left off, ensuring smooth continuation without loss of context or progress.
...
- ✅ You bring expertise in contribution design, code implementation, experimental design, results analysis, paper writing, and novelty assessment
...
- Contribution status and experiment data already gathered in previous sessions
...
- `contributions`: List of contributions being developed
...
- Read `step-02-contribution-design.md`
- Read `step-03-implementation.md`
...
- What contributions have been designed
...
"Welcome back! I see we've completed [X] steps of your contribution development workflow.

We last worked on [brief description of last step based on step file].

Based on our progress:
- [Summary of contributions in progress]
...
"Are you still aligned with the contributions and experimental setup we planned?"
