...
- Link questions, experiments, claims, decisions, reviews, literature notes, configs, scripts, results, and paper sections when the link changes how a reader interprets the project.
