---
name: paper-review-weaknesses
description: "Identify weaknesses of the paper with evidence (what is lacking or problematic)."
---

# Paper Review: Weaknesses

## When to Use

- You are running a structured review pass (e.g. **review-paper** command) and need to list weaknesses.
- The user wants to know what is weak or missing in the current paper or experiments.
