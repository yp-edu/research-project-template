...
description: "One-paper-per-note structure and grouping by theme; output is structured notes usable for background/related work."
---

# Literature Notes Skill

## When to Use

- You have a list of papers (e.g. from **literature-search**) and need to summarize each in a consistent structure.
- You need to group papers by theme (e.g. baselines, methods, datasets) for background or related work.
